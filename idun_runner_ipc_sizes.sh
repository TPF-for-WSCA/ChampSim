...
do
    ...
    do
        ...
        srun --account=share-ie-idi -J num-collection-$(basename ${bin}) --mail-user=romankb@ntnu.no --mail-type=FAIL --mem-per-cpu=8G -n1 -c20 -t02:30:00 -o /cluster/work/romankb/google-%j.out  -e /cluster/work/romankb/google-%j.err  python /cluster/home/romankb/ChampSim/data_collector.py --warmup 50000000 --evaluation 50000000 --intel --experiment_executable ${bin} --traces_directory /cluster/work/romankb/dataset/google/whiskey             --nosub --output_dir /cluster/work/romankb/results/$(basename ${dir})/google_whiskey/sizes_$(basename ${bin})/ >> /cluster/work/romankb/pyrunner_google_whiskey_$(basename ${bin}).log &
        srun --account=share-ie-idi -J num-collection-$(basename ${bin}) --mail-user=romankb@ntnu.no --mail-type=FAIL --mem-per-cpu=8G -n1 -c20 -t02:30:00 -o /cluster/work/romankb/google-%j.out  -e /cluster/work/romankb/google-%j.err  python /cluster/home/romankb/ChampSim/data_collector.py --warmup 50000000 --evaluation 50000000 --intel --experiment_executable ${bin} --traces_directory /cluster/work/romankb/dataset/google/merced              --nosub --output_dir /cluster/work/romankb/results/$(basename ${dir})/google_merced/sizes_$(basename ${bin})/  >> /cluster/work/romankb/pyrunner_google_merced_$(basename ${bin}).log  &
        srun --account=share-ie-idi -J num-collection-$(basename ${bin}) --mail-user=romankb@ntnu.no --mail-type=FAIL --mem-per-cpu=8G -n1 -c20 -t02:30:00 -o /cluster/work/romankb/google-%j.out  -e /cluster/work/romankb/google-%j.err  python /cluster/home/romankb/ChampSim/data_collector.py --warmup 50000000 --evaluation 50000000 --intel --experiment_executable ${bin} --traces_directory /cluster/work/romankb/dataset/google/delta               --nosub --output_dir /cluster/work/romankb/results/$(basename ${dir})/google_delta/sizes_$(basename ${bin})/   >> /cluster/work/romankb/pyrunner_google_delta_$(basename ${bin}).log &
        srun --account=share-ie-idi -J num-collection-$(basename ${bin}) --mail-user=romankb@ntnu.no --mail-type=FAIL --mem-per-cpu=8G -n1 -c20 -t02:30:00 -o /cluster/work/romankb/google-%j.out  -e /cluster/work/romankb/google-%j.err  python /cluster/home/romankb/ChampSim/data_collector.py --warmup 50000000 --evaluation 50000000 --intel --experiment_executable ${bin} --traces_directory /cluster/work/romankb/dataset/google/charlie             --nosub --output_dir /cluster/work/romankb/results/$(basename ${dir})/google_charlie/sizes_$(basename ${bin})/ >> /cluster/work/romankb/pyrunner_google_charlie_$(basename ${bin}).log &
    done
done
