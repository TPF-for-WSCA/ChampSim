...
do
    ...
    do
        srun --account=share-ie-idi -J num-collection-$(basename ${bin}) --mail-user=romankb@ntnu.no --mail-type=FAIL --mem-per-cpu=8G -n1 -c20 -t01:30:00 -o /cluster/work/romankb/latency-%j.out -e /cluster/work/romankb/latency-%j.err python /cluster/home/romankb/ChampSim/data_collector.py --warmup 50000000 --evaluation 50000000 --experiment_executable ${bin} --traces_directory /cluster/work/romankb/dataset/IPC1_new_translated/spec --nosub --output_dir   /cluster/work/romankb/results/micro_rebuttal_32_64_distill/spec/sizes_$(basename ${bin})/   >> /cluster/work/romankb/pyrunner_latency_fixed_spec_$(basename ${bin}).log &
        srun --account=share-ie-idi -J num-collection-$(basename ${bin}) --mail-user=romankb@ntnu.no --mail-type=FAIL --mem-per-cpu=8G -n1 -c20 -t01:30:00 -o /cluster/work/romankb/latency-%j.out -e /cluster/work/romankb/latency-%j.err python /cluster/home/romankb/ChampSim/data_collector.py --warmup 50000000 --evaluation 50000000 --experiment_executable ${bin} --traces_directory /cluster/work/romankb/dataset/IPC1_new_translated/server --nosub --output_dir   /cluster/work/romankb/results/micro_rebuttal_32_64_distill/server/sizes_$(basename ${bin})/   >> /cluster/work/romankb/pyrunner_latency_fixed_server_$(basename ${bin}).log &
        srun --account=share-ie-idi -J num-collection-$(basename ${bin}) --mail-user=romankb@ntnu.no --mail-type=FAIL --mem-per-cpu=8G -n1 -c20 -t01:30:00 -o /cluster/work/romankb/latency-%j.out -e /cluster/work/romankb/latency-%j.err python /cluster/home/romankb/ChampSim/data_collector.py --warmup 50000000 --evaluation 50000000 --experiment_executable ${bin} --traces_directory /cluster/work/romankb/dataset/IPC1_new_translated/client --nosub --output_dir   /cluster/work/romankb/results/micro_rebuttal_32_64_distill/client/sizes_$(basename ${bin})/   >> /cluster/work/romankb/pyrunner_latency_fixed_client_$(basename ${bin}).log &
    done
done
