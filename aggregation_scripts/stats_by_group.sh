...
do
    ...
    ${pg_dir}plotgen --debug -i ./${b}/branch_mpki.tsv --drop-any-nan-col --palette bright --normalise-to-row ${normalise_to_row} --apply-func sub 1 --apply-icolumns : --apply-function cset = nan 0 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --transpose --sort-function name --sort-columns --sort-by-column sizes_champsim_vcl_buffer_fdip_64d --reverse-columns --row-names --renameregex 'uuujq' --add-function mean --add-row AVG --ignore-columns $((2**15)) --column-names 'sizes_champsim_vcl_buffer_fdip_64d:UBS cache' --file ./raw_data/branch_mpki_relative_${b}.tsv  --width 1350 --height 300 -o ./graphs/branch_mpki_relative_${b}.html  &
    ${pg_dir}plotgen --debug -i ./${b}/aliasing.tsv --drop-any-nan-col --palette bright --apply-function cset = nan 1 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --renameregex '(.*)\..*trace' --add-function mean --add-row AVG --file ./raw_data/aliasing_relative_${b}.tsv  --width 1350 --height 300 -o ./graphs/aliasing_relative_${b}.html  &
    ${pg_dir}plotgen --debug -i ./${b}/total_aliasing.tsv --drop-any-nan-col --palette bright --apply-function cset = nan 1 --apply-icolumns : --x-type category --plot bar --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --renameregex '(.*)\..*trace' --add-function mean --add-row AVG --file ./raw_data/aliasing_absolute_${b}.tsv  --width 1350 --height 300 -o ./graphs/alias_absolute_${b}.html  &
    ${pg_dir}plotgen --debug -i ./${b}/btb_tag_entropy.tsv --drop-any-nan-col --palette bright --apply-function cset = nan 1 --apply-icolumns : --x-type category --plot bar --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --renameregex '(.*)\..*trace' --add-function mean --add-row AVG --file ./raw_data/entropy_${b}.tsv  --width 1350 --height 300 -o ./graphs/entropy_${b}.html  &
    ${pg_dir}plotgen --debug -i ./${b}/btb_region_tag_split.tsv --drop-any-nan-col --palette bright --apply-function cset = nan 1 --apply-icolumns : --x-type category --plot bar --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --renameregex '(.*)\..*trace' --add-function mean --add-row AVG --file ./raw_data/region_split_${b}.tsv  --width 1350 --height 300 -o ./graphs/region_split_${b}.html  &
    ...
    do
        for way in ${ways[@]}
        do
            ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_256/${percentage}_way_${way}_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/256_regions_${percentage}_way_${way}_regions_${b}.html &
        
            ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_128/${percentage}_way_${way}_region_sampling.tsv  --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/128_regions_${percentage}_way_${way}_regions_${b}.html &

            ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_64/${percentage}_way_${way}_region_sampling.tsv  --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/64_regions_${percentage}_way_${way}_regions_${b}.html  &

            ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_32/${percentage}_way_${way}_region_sampling.tsv  --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/32_regions_${percentage}_way_${way}_regions_${b}.html &

            ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_16/${percentage}_way_${way}_region_sampling.tsv  --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/16_regions_${percentage}_way_${way}_regions_${b}.html &

            ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_8/${percentage}_way_${way}_region_sampling.tsv  --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/8_regions_${percentage}_way_${way}_regions_${b}.html &
        done
        ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_256/${percentage}%_overall_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/${percentage}_256_overall_region_sampling.html &
        ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_128/${percentage}%_overall_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/${percentage}_128_overall_region_sampling.html &
        ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_64/${percentage}%_overall_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/${percentage}_64_overall_region_sampling.html &
        ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_32/${percentage}%_overall_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/${percentage}_32_overall_region_sampling.html &
        ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_16/${percentage}%_overall_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/${percentage}_16_overall_region_sampling.html &
        ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_8/${percentage}%_overall_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/${percentage}_8_overall_region_sampling.html &
    ...
    # ${pg_dir}plotgen --debug -i ./${b}/partial_misses_sizes_champsim_vcl_buffer_fdip_extend_64d.tsv --drop-any-nan-col --transpose --normalise-function sum --normalise-irows : --sort-function name --sort-rows --row-names --renameregex '(.*)\..*trace' --file ./raw_data/partial_detail_${b}.tsv --y-tick-format ',.2%'  --palette bright --x-type category --plot bar --width 1350 --height 300 -o ./graphs/partial_detail_extend_${b}.html  &
    # ${pg_dir}plotgen --debug -i ./${b}/useless.tsv --drop-any-nan-col --palette bright  --apply-function cset = nan 0 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --transpose --sort-function name --sort-rows --row-names --renameregex '(.*)\..*trace' --add-function mean --add-row AVG --file ./raw_data/useless_relative_${b}.tsv --width 1350 --height 300 -o ./graphs/useless_relative_${b}.html  &
...
${pg_dir}plotgen --debug -i ./**/branch_mpki.tsv --drop-any-nan-col --palette bright --normalise-to-row ${normalise_to_row}  --apply-function cset = nan 0 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --join index --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --row-names --renameregex '(.*)\..*trace' --add-function mean --add-row AVG --apply-func sub 1 --apply-icolumns : --ignore-columns $((2**15)) --column-names 'sizes_champsim_vcl_buffer_fdip_64d:UBS cache' --file ./raw_data/branch_mpki_relative_overall.tsv --width 1350 --height 300 -o ./graphs/branch_mpki_relative_overall.html &
${pg_dir}plotgen --debug -i ./**/aliasing.tsv --drop-any-nan-col --palette bright --apply-function cset = nan 1 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --join index --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --renameregex '(.*)\..*trace' --add-function mean --add-row AVG --file ./raw_data/aliasing_relative_overall.tsv --width 1350 --height 300 -o ./graphs/aliasing_relative_overall.html &
${pg_dir}plotgen --debug -i ./**/total_aliasing.tsv --drop-any-nan-col --palette bright --apply-function cset = nan 1 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --join index --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --renameregex '(.*)\..*trace' --add-function mean --add-row AVG --file ./raw_data/aliasing_absolute_overall.tsv --width 1350 --height 300 -o ./graphs/aliasing_absolute_overall.html &
${pg_dir}plotgen --debug -i ./**/btb_tag_entropy.tsv --drop-any-nan-col --palette bright --apply-function cset = nan 1 --apply-icolumns : --x-type category --plot bar --join index --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --renameregex '(.*)\..*trace' --add-function mean --add-row AVG --file ./raw_data/entropy_overall.tsv --width 1350 --height 300 -o ./graphs/entropy_overall.html &
...
# ${pg_dir}plotgen --debug -i ./**/fetch_count.tsv --drop-any-nan-col --palette bright --normalise-to-row ${normalise_to_row}  --apply-function cset = nan 0 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --join index --transpose --sort-function name --sort-rows --row-names --row-names --renameregex '(.*)\..*trace' --add-function mean --add-row AVG --apply-func sub 1 --apply-icolumns : --ignore-columns $((2**15)) --column-names 'sizes_champsim_vcl_buffer_fdip_64d:UBS cache' --file ./raw_data/fetch_count_relative_overall.tsv --width 1350 --height 300 -o ./graphs/fetch_count_relative_overall.html &
# ${pg_dir}plotgen --debug -i ./**/frontend_stalls.tsv --drop-any-nan-col --palette bright --normalise-to-row ${normalise_to_row}  --apply-function cset = nan 0 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --join index --transpose --sort-function name --sort-rows --row-names --row-names --renameregex '(.*)\..*trace' --add-function mean --add-row AVG --apply-func sub 1 --apply-icolumns : --ignore-columns $((2**15)) --column-names 'sizes_champsim_vcl_buffer_fdip_64d:UBS cache' --file ./raw_data/frontend_stalls_relative_overall.tsv --width 1350 --height 300 -o ./graphs/frontend_stalls_relative_overall.html &
# ${pg_dir}plotgen --debug -i ./**/partial.tsv --drop-any-nan-col --apply-func div 100 --apply-icolumns : --palette bright --apply-function cset = nan 0 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --transpose --sort-function name --sort-rows --column-names 'sizes_champsim_vcl_buffer_fdip_64d:UBS cache' --column-names --filename --join columns --row-names --renameregex '(.*)\..*trace' --select-column "UBS cache" --file ./raw_data/partial_relative_overall.tsv --width 625 --height 300 -o ./graphs/partial_relative_overall.html &
