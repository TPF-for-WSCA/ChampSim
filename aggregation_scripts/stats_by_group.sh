...
${pg_dir}plotgen --debug -i ./**/partial.tsv --drop-nan --apply-func div 100 --apply-icolumns : --palette bright --apply-function cset = nan 0 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --transpose --sort-function name --sort-rows --column-names 'sizes_champsim_vcl_buffer_64d_data:UBS cache' --column-names --filename --join columns --row-names --renameregex '(.*)\.champsimtrace' --select-column "UBS cache" --file ./raw_data/partial_relative_overall.tsv --width 1350 --height 300 -o ./graphs/partial_relative_overall.html ./graphs/partial_relative_overall.pdf 
