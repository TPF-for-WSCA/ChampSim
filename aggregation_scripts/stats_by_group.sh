...
if [ $# -lt 1 ]; then
    ...
    do
        ...
        python ${chroot}/ChampSim/aggregation_scripts/json_data.py ./${b}/sizes_btb_tag_16b_region_64/ &  # TODO: only run when available
        python ${chroot}/ChampSim/aggregation_scripts/json_data.py ./${b}/sizes_btb_tag_16b_region_32/ &  # TODO: only run when available
        python ${chroot}/ChampSim/aggregation_scripts/json_data.py ./${b}/sizes_btb_tag_16b_region_16/ &  # TODO: only run when available
        python ${chroot}/ChampSim/aggregation_scripts/json_data.py ./${b}/sizes_btb_tag_16b_region_8/ &  # TODO: only run when available
...
do
    ...
    ${pg_dir}plotgen --debug -i ./${b}/aliasing.tsv --drop-nan --palette bright --apply-function cset = nan 1 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --renameregex '(.*)\..*trace' --add-function mean --add-row AVG --file ./raw_data/aliasing_relative_${b}.tsv  --width 1350 --height 300 -o ./graphs/aliasing_relative_${b}.html ./graphs/aliasing_relative_${b}.pdf  &
    ${pg_dir}plotgen --debug -i ./${b}/total_aliasing.tsv --drop-nan --palette bright --apply-function cset = nan 1 --apply-icolumns : --x-type category --plot bar --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --renameregex '(.*)\..*trace' --add-function mean --add-row AVG --file ./raw_data/aliasing_absolute_${b}.tsv  --width 1350 --height 300 -o ./graphs/alias_absolute_${b}.html ./graphs/alias_absolute_${b}.pdf  &
    ${pg_dir}plotgen --debug -i ./${b}/btb_tag_entropy.tsv --drop-nan --palette bright --apply-function cset = nan 1 --apply-icolumns : --x-type category --plot bar --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --renameregex '(.*)\..*trace' --add-function mean --add-row AVG --file ./raw_data/entropy_${b}.tsv  --width 1350 --height 300 -o ./graphs/entropy_${b}.html ./graphs/entropy_${b}.pdf  &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_256/100_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/100_regions_${b}.html ./graphs/100_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_256/99.5_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/995_regions_${b}.html ./graphs/995_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_256/99_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/99_regions_${b}.html ./graphs/99_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_256/95_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/95_regions_${b}.html ./graphs/95_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_256/90_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/90_regions_${b}.html ./graphs/90_regions_${b}.pdf &
    

	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_128/100_region_sampling.tsv  --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/128_regions_100_regions_${b}.html ./graphs/128_regions_100_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_128/99.5_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/128_regions_995_regions_${b}.html ./graphs/128_regions_995_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_128/99_region_sampling.tsv   --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/128_regions_99_regions_${b}.html  ./graphs/128_regions_99_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_128/95_region_sampling.tsv   --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/128_regions_95_regions_${b}.html  ./graphs/128_regions_95_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_128/90_region_sampling.tsv   --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/128_regions_90_regions_${b}.html  ./graphs/128_regions_90_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_64/100_region_sampling.tsv  --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/64_regions_100_regions_${b}.html  ./graphs/64_regions_100_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_64/99.5_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/64_regions_995_regions_${b}.html  ./graphs/64_regions_995_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_64/99_region_sampling.tsv   --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/64_regions_99_regions_${b}.html   ./graphs/64_regions_99_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_64/95_region_sampling.tsv   --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/64_regions_95_regions_${b}.html   ./graphs/64_regions_95_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_64/90_region_sampling.tsv   --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/64_regions_90_regions_${b}.html   ./graphs/64_regions_90_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_32/100_region_sampling.tsv  --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/32_regions_100_regions_${b}.html ./graphs/32_regions_100_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_32/99.5_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/32_regions_995_regions_${b}.html ./graphs/32_regions_995_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_32/99_region_sampling.tsv   --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/32_regions_99_regions_${b}.html  ./graphs/32_regions_99_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_32/95_region_sampling.tsv   --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/32_regions_95_regions_${b}.html  ./graphs/32_regions_95_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_32/90_region_sampling.tsv   --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/32_regions_90_regions_${b}.html  ./graphs/32_regions_90_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_16/100_region_sampling.tsv  --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/16_regions_100_regions_${b}.html ./graphs/16_regions_100_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_16/99.5_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/16_regions_995_regions_${b}.html ./graphs/16_regions_995_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_16/99_region_sampling.tsv   --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/16_regions_99_regions_${b}.html  ./graphs/16_regions_99_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_16/95_region_sampling.tsv   --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/16_regions_95_regions_${b}.html  ./graphs/16_regions_95_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_16/90_region_sampling.tsv   --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/16_regions_90_regions_${b}.html  ./graphs/16_regions_90_regions_${b}.pdf &
    

	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_8/100_region_sampling.tsv  --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/8_regions_100_regions_${b}.html ./graphs/8_regions_100_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_8/99.5_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/8_regions_995_regions_${b}.html ./graphs/8_regions_995_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_8/99_region_sampling.tsv   --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/8_regions_99_regions_${b}.html  ./graphs/8_regions_99_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_8/95_region_sampling.tsv   --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/8_regions_95_regions_${b}.html  ./graphs/8_regions_95_regions_${b}.pdf &
	${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_8/90_region_sampling.tsv   --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/8_regions_90_regions_${b}.html  ./graphs/8_regions_90_regions_${b}.pdf &
