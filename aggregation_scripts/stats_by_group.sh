...
do
    ...
    ${pg_dir}plotgen --debug -i ./${b}/partial.tsv --drop-nan --apply-func div 100 --apply-icolumns : --palette bright --apply-function cset = nan 0 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --transpose --sort-by-column sizes_champsim_vcl_buffer_64d_data --file ./raw_data/partial_relative_${b}.tsv -o ./graphs/partial_relative_${b}.html --width 1800 --height 400 -o ./graphs/partial_relative_${b}.pdf 
