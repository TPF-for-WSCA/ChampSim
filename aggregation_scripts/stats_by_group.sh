...
do
    ...
    ${pg_dir}plotgen --debug -i ./${b}/region_btb_replacements.tsv --drop-any-nan-col --palette bright --apply-function cset = nan 0 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --transpose --sort-function name --sort-columns --sort-by-column sizes_champsim_vcl_buffer_fdip_64d --reverse-columns --row-names --renameregex 'uuujq' --add-function mean --add-row AVG --ignore-columns $((2**15)) --column-names 'sizes_champsim_vcl_buffer_fdip_64d:UBS cache' --normalise-to-column ${normalise_to_row} --apply-func sub 1 --apply-icolumns : --file ./raw_data/region_btb_replacements_${b}.tsv  --width 1350 --height 300 -o ./graphs/region_btb_replacements_${b}.html  &
...
${pg_dir}plotgen --debug -i ./**/region_btb_replacements.tsv --drop-any-nan-col --palette bright --apply-function cset = nan 0 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --join index --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --row-names --renameregex '(.*)\..*trace' --add-function mean --add-row AVG --ignore-columns $((2**15)) --column-names 'sizes_champsim_vcl_buffer_fdip_64d:UBS cache' --file ./raw_data/region_btb_replacements_absolute_overall.tsv --width 1350 --height 300 -o ./graphs/region_btb_replacements_absolute_overall.html &
