...
do
    ...
    ${pg_dir}plotgen --debug -i ./${b}/partial_misses_sizes_champsim_vcl_buffer_64d_data.tsv --drop-nan --transpose --file ./raw_data/partial_detail_${b}.tsv --palette bright --x-type category --plot bar --width 1350 --height 300 -o ./graphs/partial_detail_${b}.html ./graphs/partial_detail_${b}.pdf 
