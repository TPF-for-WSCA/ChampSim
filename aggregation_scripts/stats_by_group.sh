...
do
    ...
    do
        for way in ${ways[@]}
        do
            ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_256/${percentage}_way_${way}_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/256_regions_${percentage}_way_${way}_regions_${b}.html ./graphs/256_regions_${percentage}_way_${way}_regions_${b}.pdf &
        
            ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_128/${percentage}_way_${way}_region_sampling.tsv  --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/128_regions_${percentage}_way_${way}_regions_${b}.html ./graphs/128_regions_${percentage}_way_${way}_regions_${b}.pdf &

            ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_64/${percentage}_way_${way}_region_sampling.tsv  --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/64_regions_${percentage}_way_${way}_regions_${b}.html  ./graphs/64_regions_${percentage}_way_${way}_regions_${b}.pdf &

            ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_32/${percentage}_way_${way}_region_sampling.tsv  --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/32_regions_${percentage}_way_${way}_regions_${b}.html ./graphs/32_regions_${percentage}_way_${way}_regions_${b}.pdf &

            ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_16/${percentage}_way_${way}_region_sampling.tsv  --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/16_regions_${percentage}_way_${way}_regions_${b}.html ./graphs/16_regions_${percentage}_way_${way}_regions_${b}.pdf &

            ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_8/${percentage}_way_${way}_region_sampling.tsv  --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/8_regions_${percentage}_way_${way}_regions_${b}.html ./graphs/8_regions_${percentage}_way_${way}_regions_${b}.pdf &
        done
