...
do
    ...
    ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_256/overall_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/256_overall_region_sampling.html &
    ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_128/overall_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/128_overall_region_sampling.html &
    ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_64/overall_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/64_overall_region_sampling.html &
    ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_32/overall_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/32_overall_region_sampling.html &
    ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_16/overall_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/16_overall_region_sampling.html &
    ${pg_dir}plotgen --debug -i ./${b}/sizes_btb_tag_16b_region_8/overall_region_sampling.tsv --palette bright --violin-mode overlay --violin-mean line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/8_overall_region_sampling.html &
