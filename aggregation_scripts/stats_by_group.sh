...
#benchmarks=("tanvir")
#inputs: 
benchmarks=("ipc1_server" "ipc1_client") # "ipc1_spec" "LLBP" "google_merced" "google_charlie" "google_delta" "google_whiskey") # "cvp1_srv_secret" "LLBP" "dpc3" "google_merced" "google_charlie" "google_delta" "google_whiskey") #  "LLBP")
