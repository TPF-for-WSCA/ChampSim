...
do
    ...
    ${pg_dir}plotgen --debug -i ./${b}/ipc.tsv --drop-any-nan-col --palette bright --apply-func cset = nan 0 --apply-icolumns : --x-type category --plot bar --join index --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --row-names --renameregex '(.*)\..*trace' --add-function ${mean} --add-row ${avg_row_name} --file ./raw_data/ipc_absolute_${b}.tsv  --width 1350 --height 300 -o ./graphs/ipc_absolute_${b}.html  &
    ${pg_dir}plotgen --debug -i ./${b}/branch_mpki.tsv --drop-any-nan-col --palette bright --apply-function cset = nan 0 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --transpose --sort-function name --sort-columns --sort-by-column sizes_champsim_vcl_buffer_fdip_64d --reverse-columns --row-names --renameregex 'uuujq' --add-function ${mean} --add-row ${avg_row_name} --ignore-columns $((2**15)) --column-names 'sizes_champsim_vcl_buffer_fdip_64d:UBS cache' --normalise-to-column ${normalise_to_row} --apply-func sub 1 --apply-icolumns : --file ./raw_data/branch_mpki_relative_${b}.tsv  --width 1350 --height 300 -o ./graphs/branch_mpki_relative_${b}.html  &
    ${pg_dir}plotgen --debug -i ./${b}/utb_mpki.tsv --drop-any-nan-col --palette bright --apply-function cset = nan 0 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --transpose --sort-function name --sort-columns --sort-by-column sizes_champsim_vcl_buffer_fdip_64d --reverse-columns --row-names --renameregex 'uuujq' --add-function mean --add-row AVG --ignore-columns $((2**15)) --column-names 'sizes_champsim_vcl_buffer_fdip_64d:UBS cache' --normalise-to-column ${normalise_to_row} --apply-func sub 1 --apply-icolumns : --file ./raw_data/utb_mpki_relative_${b}.tsv  --width 1350 --height 300 -o ./graphs/utb_mpki_relative_${b}.html  &
    ${pg_dir}plotgen --debug -i ./${b}/eager_invalidation_mpki.tsv --drop-any-nan-col --palette bright --apply-function cset = nan 0 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --transpose --sort-function name --sort-columns --sort-by-column sizes_champsim_vcl_buffer_fdip_64d --reverse-columns --row-names --renameregex 'uuujq' --add-function mean --add-row AVG --ignore-columns $((2**15)) --column-names 'sizes_champsim_vcl_buffer_fdip_64d:UBS cache' --normalise-to-column ${normalise_to_row} --apply-func sub 1 --apply-icolumns : --file ./raw_data/eager_invalidation_relative_${b}.tsv  --width 1350 --height 300 -o ./graphs/eager_invalidation_relative_${b}.html  &
    ${pg_dir}plotgen --debug -i ./${b}/region_btb_replacements.tsv --drop-any-nan-col --palette bright --apply-function cset = nan 0 --apply-icolumns : --x-type category --plot bar --transpose --sort-function name --sort-columns --add-function ${mean} --add-row ${avg_row_name} --ignore-columns $((2**15)) --column-names 'sizes_champsim_vcl_buffer_fdip_64d:UBS cache' --file ./raw_data/region_btb_replacements_${b}.tsv  --width 1350 --height 300 -o ./graphs/region_btb_replacements_${b}.html  &
    ${pg_dir}plotgen --debug -i ./${b}/aliasing.tsv --drop-any-nan-col --palette bright --apply-function cset = nan 1 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --renameregex '(.*)\..*trace' --add-function ${mean} --add-row ${avg_row_name} --file ./raw_data/aliasing_relative_${b}.tsv  --width 1350 --height 300 -o ./graphs/aliasing_relative_${b}.html  &
    ${pg_dir}plotgen --debug -i ./${b}/total_aliasing.tsv --palette bright --apply-function cset = nan 1 --apply-icolumns : --x-type category --plot bar --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --renameregex '(.*)\..*trace' --add-function ${mean} --add-row ${avg_row_name} --file ./raw_data/aliasing_absolute_${b}.tsv  --width 1350 --height 300 -o ./graphs/alias_absolute_${b}.html  &
    ${pg_dir}plotgen --debug -i ./${b}/absolute_btb_hits.tsv --palette bright --apply-function cset = nan 1 --apply-icolumns : --x-type category --plot bar --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --renameregex '(.*)\..*trace' --add-function ${mean} --add-row ${avg_row_name} --file ./raw_data/btb_hits_${b}.tsv  --width 1350 --height 300 -o ./graphs/btb_hits_${b}.html  &
    ${pg_dir}plotgen --debug -i ./${b}/btb_tag_entropy.tsv --drop-any-nan-col --palette bright --apply-function cset = nan 1 --apply-icolumns : --x-type category --plot bar --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --renameregex '(.*)\..*trace' --add-function ${mean} --add-row ${avg_row_name} --file ./raw_data/entropy_${b}.tsv  --width 1350 --height 300 -o ./graphs/entropy_${b}.html  &
    ${pg_dir}plotgen --debug -i ./${b}/btb_region_tag_split.tsv --drop-any-nan-col --palette bright --x-type category --plot bar --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --renameregex '(.*)\..*trace' --add-function ${mean} --add-row ${avg_row_name} --add-function min --add-row MIN --add-function max --add-row MAX --file ./raw_data/region_split_${b}.tsv  --width 1350 --height 300 -o ./graphs/region_split_${b}.html  &
    ...
    do
        if [ -d "$config" ]; then
            ...
            #     # for way in ${ways[@]}
            #     # do
            #     #     ${pg_dir}plotgen --debug -i ${config}/${percentage}_way_${way}_region_sampling.tsv --palette bright --violin-mode overlay --violin- line --violin-points none --violin-gap 0.25 --legend-hide --sort-function name --sort-columns --plot violin -o ./graphs/$(basename ${config})_256_regions_${percentage}_way_${way}_regions_${b}.html &
            #     # done
...
${pg_dir}plotgen --debug -i ./**/branch_mpki.tsv --drop-any-nan-col --palette bright --apply-function cset = nan 0 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --join index --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --row-names --renameregex '(.*)\..*trace' --add-function ${mean} --add-row ${avg_row_name} --ignore-columns $((2**15)) --column-names 'sizes_champsim_vcl_buffer_fdip_64d:UBS cache' --normalise-to-column ${normalise_to_row} --apply-func sub 1 --apply-icolumns : --file ./raw_data/branch_mpki_relative_overall.tsv --width 1350 --height 300 -o ./graphs/branch_mpki_relative_overall.html &
${pg_dir}plotgen --debug -i ./**/region_switching_frequency.tsv --drop-any-nan-row --palette bright --apply-function cset = nan 0 --apply-icolumns : --x-type category --y-tick-format ',.2%' --plot bar --join index --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --row-names --renameregex '(.*)\..*trace' --add-function ${mean} --add-row ${avg_row_name} --file ./raw_data/region_change_frequency.tsv --width 1350 --height 300 -o ./graphs/region_change_frequency.html &
${pg_dir}plotgen --debug -i ./**/region_btb_replacements.tsv --drop-any-nan-col --palette bright --apply-function cset = nan 0 --apply-icolumns : --x-type category --plot bar --join index --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --row-names --renameregex '(.*)\..*trace' --add-function ${mean} --add-row ${avg_row_name} --file ./raw_data/region_btb_replacements_absolute_overall.tsv --width 1350 --height 300 -o ./graphs/region_btb_replacements_absolute_overall.html &
...
${pg_dir}plotgen --debug -i ./**/total_aliasing.tsv --drop-any-nan-col --palette bright --apply-function cset = nan 1 --apply-icolumns : --x-type category --plot bar --join index --transpose --sort-function name --sort-columns --sort-function name --sort-rows --row-names --renameregex '(.*)\..*trace' --add-function ${mean} --add-row ${avg_row_name} --file ./raw_data/aliasing_absolute_overall.tsv --width 1350 --height 300 -o ./graphs/aliasing_absolute_overall.html &
