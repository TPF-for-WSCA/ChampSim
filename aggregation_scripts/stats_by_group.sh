...
#benchmarks=("tanvir")
#benchmarks=("ipc1_server" "ipc1_client" "ipc1_spec" "cvp1")
...
do
    ...
    python ${chroot}/ChampSim/aggregation_scripts/ipc_data.py ./${b}/sizes_champsim32k single PREDICTOR_ACCURACY &
