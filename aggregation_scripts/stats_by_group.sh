...
do
    ...
    ${pg_dir}plotgen --debug -i ./${b}/partial_misses.tsv --drop-nan --file ./raw_data/partial_detail_${b}.tsv --group-by-irows 0 --palette bright --x-type category --plot bar -o ./graphs/partial_detail_${b}.html --width 1350 --height 300 -o ./graphs/partial_detail_${b}.pdf 
