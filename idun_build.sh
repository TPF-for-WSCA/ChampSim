...
build_configs=("idun_32k_config.json" "idun_64k_config.json" "idun_32k_data_config.json" "idun_vcl_buffer_64d_fdip_config.json" "idun_vcl_buffer_64d_fdip_extendblcks_config.json")
