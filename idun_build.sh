...
build_configs=("idun_32k_config.json" "idun_128k_config.json" "idun_192k_config.json" "idun_ubs_64k_extend.json" "idun_ubs_64k_not_extend.json" "idun_ubs_128k_extend.json" "idun_ubs_128k_not_extend.json")
...
do
    ...
    ~/ChampSim/config.sh ~/ChampSim/isca_configs/${build_script}
    make -j
done
cd $old_dir
