...
struct BTBEntry {
  ...
  auto tag() const
  {
     ...
     * The lower _BTB_TAG_SIZE/2-bits stay the same as in the full tag.
     * The upper _BTB_TAG_SIZE/2-bits are the folded X-OR of the remaining bits of the full tag.
     */
    uint64_t tag = 0;
