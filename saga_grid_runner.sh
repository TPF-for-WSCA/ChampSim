...
do
    ...
    do
        # IPC-1 Benchmarks
        srun --account=nn4650k -J num-collection-$(basename ${bin}) --mail-user=romankb@ntnu.no --mail-type=FAIL --mem-per-cpu=20G -n1 -c8 -t02:00:00 -o /cluster/work/users/romankb/latency-spec-$(basename ${bin})-%j.out   -e /cluster/work/users/romankb/latency-spec-$(basename ${bin})-%j.err     python /cluster/projects/nn4650k/workspace/ChampSim/data_collector.py --warmup 15000000 --evaluation 15000000 --experiment_executable ${bin} --traces_directory /cluster/projects/nn4650k/dataset/ipc1_new/spec   --nosub --output_dir /cluster/work/users/romankb/results/${dir}_${count}/ipc1_spec/sizes_$(basename ${bin})/   >> /cluster/work/users/romankb/pyrunner_latency_fixed_ipc1_spec_$(basename ${bin}).log &
        srun --account=nn4650k -J num-collection-$(basename ${bin}) --mail-user=romankb@ntnu.no --mail-type=FAIL --mem-per-cpu=20G -n1 -c8 -t02:00:00 -o /cluster/work/users/romankb/latency-client-$(basename ${bin})-%j.out -e /cluster/work/users/romankb/latency-client-$(basename ${bin})-%j.err   python /cluster/projects/nn4650k/workspace/ChampSim/data_collector.py --warmup 15000000 --evaluation 15000000 --experiment_executable ${bin} --traces_directory /cluster/projects/nn4650k/dataset/ipc1_new/client --nosub --output_dir /cluster/work/users/romankb/results/${dir}_${count}/ipc1_client/sizes_$(basename ${bin})/ >> /cluster/work/users/romankb/pyrunner_latency_fixed_ipc1_client_$(basename ${bin}).log &
        srun --account=nn4650k -J num-collection-$(basename ${bin}) --mail-user=romankb@ntnu.no --mail-type=FAIL --mem-per-cpu=20G -n1 -c8 -t02:00:00 -o /cluster/work/users/romankb/latency-server-$(basename ${bin})-%j.out -e /cluster/work/users/romankb/latency-server-$(basename ${bin})-%j.err   python /cluster/projects/nn4650k/workspace/ChampSim/data_collector.py --warmup 15000000 --evaluation 15000000 --experiment_executable ${bin} --traces_directory /cluster/projects/nn4650k/dataset/ipc1_new/server --nosub --output_dir /cluster/work/users/romankb/results/${dir}_${count}/ipc1_server/sizes_$(basename ${bin})/ >> /cluster/work/users/romankb/pyrunner_latency_fixed_ipc1_server_$(basename ${bin}).log &
        # SPECCPU / DPC-3 Benchmarks
        srun --account=nn4650k -J num-collection-$(basename ${bin}) --mail-user=romankb@ntnu.no --mail-type=FAIL --mem-per-cpu=20G -n1 -c8 -t02:00:00 -o /cluster/work/users/romankb/latency-speccpu-$(basename ${bin})-%j.out -e /cluster/work/users/romankb/latency-speccpu-$(basename ${bin})-%j.err python /cluster/projects/nn4650k/workspace/ChampSim/data_collector.py --warmup 15000000 --evaluation 15000000 --experiment_executable ${bin} --traces_directory /cluster/projects/nn4650k/dataset/speccpu --nosub --output_dir /cluster/work/users/romankb/results/${dir}_${count}/speccpu/sizes_$(basename ${bin})/ >> /cluster/work/users/romankb/pyrunner_latency_fixed_speccpu_$(basename ${bin}).log &
        # LLBP Benchmarks
        srun --account=nn4650k -J num-collection-$(basename ${bin}) --mail-user=romankb@ntnu.no --mail-type=FAIL --mem-per-cpu=20G -n1 -c8 -t02:00:00 -o /cluster/work/users/romankb/latency-llbp-$(basename ${bin})-%j.out -e /cluster/work/users/romankb/latency-llbp-$(basename ${bin})-%j.err       python /cluster/projects/nn4650k/workspace/ChampSim/data_collector.py --warmup 15000000 --evaluation 15000000 --experiment_executable ${bin} --traces_directory /cluster/projects/nn4650k/dataset/LLBP    --nosub --output_dir /cluster/work/users/romankb/results/${dir}_${count}/llbp/sizes_$(basename ${bin})/ >> /cluster/work/users/romankb/pyrunner_latency_fixed_llbp_$(basename ${bin}).log &
