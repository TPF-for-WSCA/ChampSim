...
suffix="micro"
binary_dir=("twolevel_btb_full_grid_search") # ("region_sampling" "btb_full_grid_search") # "btb_size_region_sensitivity" "btb_4k_10b_tag_sensitivity" "btb_4k_12b_tag_sensitivity" )
count=6
timelimit="12:00:00"
warmup=50000000
simulation=50000000
