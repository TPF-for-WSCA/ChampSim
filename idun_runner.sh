...
suffix="rebuttal"
binary_dir=("ispass_btb_hashed_perceptron_grid_search" "ispass_btb_gshare_grid_search") # "ispass_pdede_btb_full_grid_search") #"ispass_btb_hashed_perceptron_grid_search" "ispass_n2_btb_full_grid_search" "ispass_n4_btb_full_grid_search" "ispass_multilevel_btb_full_grid_search") # "ispass_geometric_btb_full_grid_search" "ispass_hash_btb_full_grid_search") # "region_sensitivity"  "btb_4k_10b_tag_sensitivity" "btb_4k_12b_tag_sensitivity" )
count=0
timelimit="8:00:00"
warmup=50000000
simulation=50000000
...
do
    ...
    do
        ...
        srun --account=share-ie-idi -J num-collection-$(basename ${bin}) --mail-user=romankb@ntnu.no --mail-type=FAIL --mem-per-cpu=10G -n1 -c16 -t$timelimit -o /cluster/work/romankb/latency-client-$(basename ${bin})-%j.out  -e /cluster/work/romankb/latency-client-$(basename ${bin})-%j.err  python ~/ChampSim/data_collector.py --warmup ${warmup} --evaluation ${simulation} --experiment_executable ${bin} --traces_directory /cluster/work/romankb/dataset/IPC1_new_translated/client --nosub --output_dir /cluster/work/romankb/results/${dir}_${count}_${suffix}/ipc1_client/sizes_$(basename ${bin})/            &>> /cluster/work/romankb/pyrunner_latency_fixed_ipc1_client_$(basename ${bin}).log &
        srun --account=share-ie-idi -J num-collection-$(basename ${bin}) --mail-user=romankb@ntnu.no --mail-type=FAIL --mem-per-cpu=10G -n1 -c16 -t$timelimit -o /cluster/work/romankb/latency-server-$(basename ${bin})-%j.out  -e /cluster/work/romankb/latency-server-$(basename ${bin})-%j.err  python ~/ChampSim/data_collector.py --warmup ${warmup} --evaluation ${simulation} --experiment_executable ${bin} --traces_directory /cluster/work/romankb/dataset/IPC1_new_translated/server --nosub --output_dir /cluster/work/romankb/results/${dir}_${count}_${suffix}/ipc1_server/sizes_$(basename ${bin})/            &>> /cluster/work/romankb/pyrunner_latency_fixed_ipc1_server_$(basename ${bin}).log &
        # CVP-1 Benchmarks
        # srun --account=share-ie-idi -J num-collection-$(basename ${bin}) --mail-user=romankb@ntnu.no --mail-type=FAIL --mem-per-cpu=20G -n1 -c8 -t$timelimit -o /cluster/work/romankb/latency-server-$(basename ${bin})-%j.out  -e /cluster/work/romankb/latency-server-$(basename ${bin})-%j.err  python ~/ChampSim/data_collector.py --warmup ${warmup} --evaluation ${simulation} --experiment_executable ${bin} --traces_directory /cluster/work/romankb/dataset/CVP1public --nosub --output_dir /cluster/work/romankb/results/${dir}_${count}_${suffix}/cvp1/sizes_$(basename ${bin})/            &>> /cluster/work/romankb/pyrunner_latency_fixed_cvp1_$(basename ${bin}).log &
