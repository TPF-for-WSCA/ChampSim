...
build_dir=("full_btb_grid_search_hashed_perceptron") # "full_multi_level_btb_grid_search" "full_btb_grid_search_hashed_perceptron" "full_narrow2_btb_grid_search" "full_narrow4_btb_grid_search" "full_multi_level_btb_grid_search") # "full_geometric_btb_grid_search" "full_hash_btb_grid_search") # "4k_12b_region_tag_sensitivity" "4k_10b_region_tag_sensitivity") #  "btb_512_region_tag_exp" "btb_1k_region_tag_exp" "btb_2k_region_tag_exp" "btb_4k_region_tag_exp" "btb_8k_region_tag_exp" "btb_256_region_tag_exp")
