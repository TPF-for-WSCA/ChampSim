...
vlc_cache_fmtstr = 'VCL_CACHE {name}("{name}", {frequency}, {fill_level}, {sets}, {ways}, way_sizes, {buffer:b}, {buffer_size}, {buffer_fifo:b}, {aligned:b}, {wq_size}, {rq_size}, {pq_size}, {mshr_size}, {hit_latency}, {fill_latency}, {max_read}, {max_write}, {offset_bits}, {prefetch_as_load:b}, {wq_check_full_addr:b}, {virtual_prefetch:b}, {prefetch_activate_mask}, {lower_level}, CACHE::pref_t::{prefetcher_name}, CACHE::repl_t::{replacement_name}, BufferOrganisation::{buffer_organisation}, LruModifier::{lru_modifier}, CountBlockMethod::{counting_block_method}, BufferHistory::{buffer_history}, {filter_inserts:b}, {filter_prefetches:b}, {filter_buffer_size}, {prefetch_buffer_size}, {extend_blocks_to_branch:b});\n'
...
default_core = { 'frequency' : 4000, 'ifetch_buffer_size': 64, 'decode_buffer_size': 32, 'dispatch_buffer_size': 32, 'rob_size': 352, 'lq_size': 128, 'sq_size': 72, 'fetch_width' : 6, 'decode_width' : 6, 'dispatch_width' : 6, 'execute_width' : 4, 'lq_width' : 2, 'sq_width' : 2, 'retire_width' : 5, 'mispredict_penalty' : 1, 'scheduler_size' : 128, 'decode_latency' : 1, 'dispatch_latency' : 1, 'schedule_latency' : 0, 'execute_latency' : 0, 'branch_predictor': 'bimodal', 'btb': 'basic_btb', 'btb_sets': 4096, 'btb_ways': 8 }
default_dib  = { 'window_size': 16,'sets': 32, 'ways': 8 }
default_l1i  = { 'sets': 64, 'ways': 8, 'rq_size': 64, 'wq_size': 64, 'pq_size': 32, 'mshr_size': 8, 'latency': 4, 'fill_latency': 1, 'max_read': 2, 'max_write': 2, 'prefetch_as_load': False, 'virtual_prefetch': True, 'wq_check_full_addr': True, 'prefetch_activate': 'LOAD,PREFETCH', 'prefetcher': 'no_instr', 'replacement': 'lru', 'lru_modifier': 'DEFAULT', 'counting_block_method': 'EVICTION', 'buffer_history': 'FULL', 'filter_inserts': False, 'filter_prefetches': False, 'filter_buffer_size': 64, 'prefetch_buffer_size': 64, 'extend_blocks_to_branch': False}
default_l1d  = { 'sets': 64, 'ways': 12, 'rq_size': 64, 'wq_size': 64, 'pq_size': 8, 'mshr_size': 16, 'latency': 5, 'fill_latency': 1, 'max_read': 2, 'max_write': 2, 'prefetch_as_load': False, 'virtual_prefetch': False, 'wq_check_full_addr': True, 'prefetch_activate': 'LOAD,PREFETCH', 'prefetcher': 'no', 'replacement': 'lru', 'lru_modifier': 'DEFAULT', 'counting_block_method': 'EVICTION', 'buffer_history': 'FULL', 'filter_inserts': False, 'filter_prefetches': False, 'filter_buffer_size': 64, 'prefetch_buffer_size': 64, 'extend_blocks_to_branch': False}
default_l2c  = { 'sets': 1024, 'ways': 8, 'rq_size': 32, 'wq_size': 32, 'pq_size': 16, 'mshr_size': 32, 'latency': 10, 'fill_latency': 1, 'max_read': 1, 'max_write': 1, 'prefetch_as_load': False, 'virtual_prefetch': False, 'wq_check_full_addr': False, 'prefetch_activate': 'LOAD,PREFETCH', 'prefetcher': 'no', 'replacement': 'lru', 'lru_modifier': 'DEFAULT', 'counting_block_method': 'EVICTION', 'buffer_history': 'FULL', 'filter_inserts': False, 'filter_prefetches': False, 'filter_buffer_size': 64, 'prefetch_buffer_size': 64, 'extend_blocks_to_branch': False}
default_itlb = { 'sets': 16, 'ways': 4, 'rq_size': 16, 'wq_size': 16, 'pq_size': 0, 'mshr_size': 8, 'latency': 1, 'fill_latency': 1, 'max_read': 2, 'max_write': 2, 'prefetch_as_load': False, 'virtual_prefetch': True, 'wq_check_full_addr': True, 'prefetch_activate': 'LOAD,PREFETCH', 'prefetcher': 'no', 'replacement': 'lru', 'lru_modifier': 'DEFAULT', 'filter_inserts': False, 'filter_prefetches': False, 'filter_buffer_size': 64, 'prefetch_buffer_size': 64}
default_dtlb = { 'sets': 16, 'ways': 4, 'rq_size': 16, 'wq_size': 16, 'pq_size': 0, 'mshr_size': 8, 'latency': 1, 'fill_latency': 1, 'max_read': 2, 'max_write': 2, 'prefetch_as_load': False, 'virtual_prefetch': False, 'wq_check_full_addr': True, 'prefetch_activate': 'LOAD,PREFETCH', 'prefetcher': 'no', 'replacement': 'lru', 'lru_modifier': 'DEFAULT', 'filter_inserts': False, 'filter_prefetches': False, 'filter_buffer_size': 64, 'prefetch_buffer_size': 64}
default_stlb = { 'sets': 128, 'ways': 12, 'rq_size': 32, 'wq_size': 32, 'pq_size': 0, 'mshr_size': 16, 'latency': 8, 'fill_latency': 1, 'max_read': 1, 'max_write': 1, 'prefetch_as_load': False, 'virtual_prefetch': False, 'wq_check_full_addr': False, 'prefetch_activate': 'LOAD,PREFETCH', 'prefetcher': 'no', 'replacement': 'lru', 'lru_modifier': 'DEFAULT', 'filter_inserts': False, 'filter_prefetches': False, 'filter_buffer_size': 64, 'prefetch_buffer_size': 64}
default_llc  = { 'sets': 2048*config_file['num_cores'], 'ways': 16, 'rq_size': 32*config_file['num_cores'], 'wq_size': 32*config_file['num_cores'], 'pq_size': 32*config_file['num_cores'], 'mshr_size': 64*config_file['num_cores'], 'latency': 20, 'fill_latency': 1, 'max_read': config_file['num_cores'], 'max_write': config_file['num_cores'], 'prefetch_as_load': False, 'virtual_prefetch': False, 'wq_check_full_addr': False, 'prefetch_activate': 'LOAD,PREFETCH', 'prefetcher': 'no', 'replacement': 'lru', 'name': 'LLC', 'lower_level': 'DRAM', 'lru_modifier': 'DEFAULT', 'counting_block_method': 'EVICTION', 'filter_inserts': False, 'filter_prefetches': False, 'filter_buffer_size': 64, 'prefetch_buffer_size': 64, 'extend_blocks_to_branch': False}
...
with open(instantiation_file_name, 'wt') as wfp:
    ...
    for elem in memory_system:
        if 'pscl5_set' in elem:
            ...
            wfp.write(f'uint8_t way_sizes[{len(elem["way_sizes"])}] = {{{", ".join("{}".format(val) for val in elem["way_sizes"])}}};\n')
