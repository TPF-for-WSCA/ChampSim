...
public:
  ...
  uint64_t address = 0, v_address = 0, data = 0, instr_id = 0, ip = 0, event_cycle = std::numeric_limits<uint64_t>::max(), cycle_enqueued = 0, size = 0;
...
extern std::ostream& operator<<(std::ostream& s, const PACKET& p);
template <>
